...
namespace WhiteCat.UnityExtension
{
	...
	public static class UnityExtension
	{
		...
		/// 将欧拉角转换到 [0, 360)
		/// </summary>
		public static Vector2 StandardizeEulerAngles(this Vector2 a)
		{
			a.x = Utility.StandardizeEulerAngle(a.x);
			a.y = Utility.StandardizeEulerAngle(a.y);
			return a;
		}
		...
		/// 将欧拉角转换到 [0, 360)
		/// </summary>
		public static Vector3 StandardizeEulerAngles(this Vector3 a)
		{
			a.x = Utility.StandardizeEulerAngle(a.x);
			a.y = Utility.StandardizeEulerAngle(a.y);
			a.z = Utility.StandardizeEulerAngle(a.z);
			return a;
		}
	}
}
