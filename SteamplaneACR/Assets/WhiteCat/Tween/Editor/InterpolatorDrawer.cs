		...
		static Texture addButton
		{
			get
			{
				if (_addButton == null)
				{
					...
					{
						AssetDatabase.LoadAssetAtPath("Assets/WhiteCat/Tween/Editor/Skin/Light/add.png", typeof(Texture)) as Texture,
						AssetDatabase.LoadAssetAtPath("Assets/WhiteCat/Tween/Editor/Skin/Dark/add.png", typeof(Texture)) as Texture
					};
				}
