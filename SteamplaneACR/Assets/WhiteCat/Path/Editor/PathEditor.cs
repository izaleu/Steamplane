		...
		public static Texture menuIcon
		{
			get
			{
				if (_menuIcon == null)
				{
					...
					{
						AssetDatabase.LoadAssetAtPath("Assets/WhiteCat/Path/Editor/Skin/Light/menuIcon.png", typeof(Texture)) as Texture,
						AssetDatabase.LoadAssetAtPath("Assets/WhiteCat/Path/Editor/Skin/Dark/menuIcon.png", typeof(Texture)) as Texture
					};
				}
